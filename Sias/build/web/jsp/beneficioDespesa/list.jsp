...
<div class="input-append">
    <mtw:form action="BeneficioDespesaRead.mtw" method="post">
        <a href="BeneficioDespesaShowForm.mtw" class="btn">Novo benefício/despesa</a>
    </mtw:form>
</div>
...
<div class="tabela">
    <display:table name="lista" id="item" pagesize="15" requestURI="" defaultsort="1" sort="list">
        <display:column property="tipoBeneficioDespesa.descricao" sortable="true" title="Descrição" style="width:29%;"/>        
        <display:column class="datainicio" sortable="true" title="Data de início" style="width:10%;"/>
        <display:column class="datatermino" sortable="true" title="Data de termino" style="width:10%;"/>
        <display:column property="valor" sortable="true" title="Valor" style="width:5%;"/>        
        <display:column class="dataatualizacao" sortable="true" title="Data de atualização do valor" style="width:15%;"/>
