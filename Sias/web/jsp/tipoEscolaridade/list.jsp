...
<div class="input-append">
    <mtw:form action="TipoEscolaridadeRead.mtw" method="post">
        ...
        <a href="TipoEscolaridadeShowForm.mtw" class="btn">Nova escolaridade</a>
        <button class="btn" type="submit">Procurar escolaridade</button>
    </mtw:form>
</div>

<legend><strong>> 1. Procura por escolaridade - Escolaridade(es) encontrada(as)</strong></legend>
<div class="tabela">
    <display:table name="lista" id="item" pagesize="15" requestURI="" defaultsort="1" sort="list">
        ...
        <display:column value="Alterar" href="TipoEscolaridadeShowForm.mtw" title="Opções" paramId="id" paramProperty="id" style="width:5%;"/>
        <display:column value="Excluir" href="TipoEscolaridadeDelete.mtw" class="deleteLink" paramId="id" paramProperty="id" style="width:5%;"/>
    </display:table>
</div>
