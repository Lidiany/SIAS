...
<mtw:form klass="form-horizontal" action="PessoaUpdate.mtw" method="post">
    ...
    <div class="control-group">
        ...
        <div class="controls radio">
            <label>
                <input type="radio" name="pessoa.sexo" value="0" <c:if test="${pessoa.sexo eq '0'}">checked</c:if> /> Masculino
            </label>
        </div>
        <div class="controls radio">
            <label>
                <input checked="yes" type="radio" name="pessoa.sexo" value="1" <c:if test="${pessoa.sexo eq '1'}">checked</c:if> /> Feminino
