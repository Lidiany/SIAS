...
<div class="input-append">
    <mtw:form action="TipoParentescoRead.mtw" method="post">
        ...
        <a href="TipoParentescoShowForm.mtw" class="btn"><i class="icon-plus"></i> Novo</a>
    </mtw:form>
</div>
...
<div class="tabela">
    <display:table name="lista" id="item" pagesize="3" requestURI="" defaultsort="1" sort="list">
        ...
        <display:column value="<i class=\"icon-edit\"></i>" href="TipoParentescoShowForm.mtw" title="Opções" paramId="id" paramProperty="id" style="width:5%;"/>
        <display:column value="<i class=\"icon-trash\"></i>" href="TipoParentescoDelete.mtw" class="deleteLink" paramId="id" paramProperty="id" style="width:5%;"/>
    </display:table>
</div>
