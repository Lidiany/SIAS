...
<div class="input-append">
    <mtw:form action="MunicipioRead.mtw" method="post">
        ...
        <a href="MunicipioShowForm.mtw" class="btn"><i class="icon-plus"></i> Novo</a>
    </mtw:form>
</div>
...
<div class="tabela">
    <display:table name="lista" id="item" pagesize="5" requestURI="" defaultsort="1" sort="list">
        ...
        <display:column property="nome" sortable="true" title="Município" style="width:40%;"/>
        <display:column property="uf.nome" sortable="true" title="UF" style="width:40%;"/>
        <display:column value="<i class=\"icon-edit\"></i>" href="MunicipioShowForm.mtw" title="Opções" paramId="id" paramProperty="id" style="width:5%;"/>
        <display:column value="<i class=\"icon-trash\"></i>" href="MunicipioDelete.mtw" class="deleteLink" paramId="id" paramProperty="id" style="width:5%;"/>
    </display:table>
</div>
