...
public class PessoaUpdateAction extends BaseAction {
    ...
    public String execute() throws Exception {
        ...
        Map<String, String> error = ServiceLocator.getPessoaService().validateForUpdate(form);
        if (error == null || error.isEmpty()) {
            ...
            pessoa.setDataInclusao(new java.sql.Date(sdf.parse((String)form.get("dataInclusao")).getTime()));
            ...
            if (dataNascimento != null && (!dataNascimento.isEmpty())) {
                pessoa.setDataNascimento(new java.sql.Date(sdf.parse(dataNascimento).getTime()));
            }
            ...
            if (dataAtualizacaoCadastro != null && (!dataAtualizacaoCadastro.isEmpty())) {
                pessoa.setDataAtualizacaoCadastro(new java.sql.Date(sdf.parse(dataAtualizacaoCadastro).getTime()));
            }
            ...
            if (dataEmissaoRg != null && (!dataEmissaoRg.isEmpty())) {
                pessoa.setDataEmissaoRg(new java.sql.Date(sdf.parse(dataEmissaoRg).getTime()));
            }
            ...
            if (dataEmissaoCtps != null && (!dataEmissaoCtps.isEmpty())) {
                pessoa.setDataEmissaoCtps(new java.sql.Date(sdf.parse(dataEmissaoCtps).getTime()));
            }
            ...
            if (dataEmissaoCn != null && (!dataEmissaoCn.isEmpty())) {
                pessoa.setDataEmissaoCn(new java.sql.Date(sdf.parse(dataEmissaoCn).getTime()));
            }
            ...
            if (dataAtualizacaoEndereco != null && (!dataAtualizacaoEndereco.isEmpty())) {
                pessoa.setDataAtualizacaoEndereco(new java.sql.Date(sdf.parse(dataAtualizacaoEndereco).getTime()));
            }
            ...
            if (dataAtualizacaoHabitacional != null && (!dataAtualizacaoHabitacional.isEmpty())) {
                pessoa.setDataAtualizacaoHabitacional(new java.sql.Date(sdf.parse(dataAtualizacaoHabitacional).getTime()));
            }
            ...
            if (dataRenda != null && (!dataRenda.isEmpty())) {
                pessoa.setDataRenda(new java.sql.Date(sdf.parse(dataRenda).getTime()));
            }
            ...
            if (dataDesligamento != null && (!dataDesligamento.isEmpty())) {
                pessoa.setDataDesligamento(new java.sql.Date(sdf.parse(dataDesligamento).getTime()));
            }
            
            pessoa.setMotivoDesligamento((String) form.get("motivoDesligamento"));

            ServiceLocator.getPessoaService().update(pessoa);
            consequence = SUCCESS;
        } else {
