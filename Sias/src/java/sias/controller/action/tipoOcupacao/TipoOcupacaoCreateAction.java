...
public class TipoOcupacaoCreateAction extends BaseAction {
    ...
    public String execute() throws Exception {
        ...
        //Validando
        Map<String, String> error = ServiceLocator.getTipoOcupacaoService().validateForCreate(form);
        if (error == null || error.isEmpty()) {
            ...
            //Persistindo
            ServiceLocator.getTipoOcupacaoService().create(tipoOcupacao);
            consequence = SUCCESS;
        } else {
